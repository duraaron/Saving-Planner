...
// Support environment variables (for PowerShell: $env:MNEMONIC, $env:SEPOLIA_RPC_URL)
...
const SEPOLIA_RPC_URL: string | undefined = process.env.SEPOLIA_RPC_URL || undefined;
